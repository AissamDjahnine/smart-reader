...
-- CreateIndex
CREATE UNIQUE INDEX "FriendBlock_blockerUserId_blockedUserId_key" ON "FriendBlock"("blockerUserId", "blockedUserId");

-- CreateIndex
CREATE INDEX "FriendBlock_blockedUserId_idx" ON "FriendBlock"("blockedUserId");
...
-- AddForeignKey
ALTER TABLE "FriendBlock" ADD CONSTRAINT "FriendBlock_blockerUserId_fkey" FOREIGN KEY ("blockerUserId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FriendBlock" ADD CONSTRAINT "FriendBlock_blockedUserId_fkey" FOREIGN KEY ("blockedUserId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
